...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gwvet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8615&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gwvet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gwvet` can be installed with:

```
conda install gwvet
```

It is possible to list all of the versions of `gwvet` available on your platform with:
